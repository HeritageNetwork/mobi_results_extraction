...
def prompt_user():
    ...
    confirm_continue = input("Do you want to continue? (y/n)") or "n"
    ...
    excel_file_name = input("Excel File (default is AWS_likely_spp.xlsx): ") or 'AWS_likely_spp.xlsx'
    excel_sheet_name = input("Excel sheet name (default is AWS_sample): ") or 'AWS_sample'
    ...
    metadata_bucket = input("Metadata S3 Bucket: ") or None
    model_prediction_bucket = input("Model Predictions S3 Bucket: ") or None

    print("\nEnter the AWS credentials for a user who has permission to upload to the buckets specified:")
    aws_access_key_id = input("AWS_ACCESS_KEY_ID: ") or None
    aws_secret_access_key = input("AWS_SECRET_ACCESS_KEY: ") or None
    aws_region_name = input("AWS Region (default is us-east-1): ") or 'us-east-1'
